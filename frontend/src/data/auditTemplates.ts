...
export interface AuditTemplate {
    ...
    /** Optional module grouping on the Audit Templates page (e.g. "EOSH"). */
    module?: string;
...
export const auditTemplates: AuditTemplate[] = [
    ...
    },
    {
        ...
        module: "EOSH",
        description:
            "EOSH internal audit checklist for Capability – Route to Market (HSHEQPF 03.08, Revision 0). Assesses Over-the-Road and Non-Production Site Safety roles, key leadership competence, and backup coverage. Score findings as Compliance (2) / Meet with Exceptions (1) / Non-Compliance (0).",
        content: [
            {
                clause: "RTM-1",
                question:
                    "Organization roles responsible for Over-The-Road Safety at the organization and local level are filled by people with extensive safety experience and training, and demonstrate Safety competence throughout the audit. The reporting structure does not create undue conflict of interest.",
                intent:
                    "Intent: evaluate that those responsible for Over-the-Road Safety at the bottler level, and other Over-the-Road Safety roles as defined by the bottler (if applicable), are competent with relevant training, qualification and experience to ensure that the Safety Management System is implemented and effective and is able to take decisions regarding the SMS.\n\n" +
            ...
            },
            {
                clause: "RTM-2",
                question:
                    "Organization roles responsible for Non-Production Site Safety at the organization and local level are filled by people with extensive safety experience and training, and demonstrate Safety competence throughout the audit. The reporting structure does not create undue conflict of interest.",
                intent:
                    "Intent: evaluate that those responsible for Non-Production Site Safety at the bottler level, and other Non-Production Site Safety roles as defined by the bottler (if applicable), are competent with relevant training, qualification and experience to ensure that the Safety Management System is implemented and effective and is able to take decisions regarding the SMS.\n\n" +
                    "Depending on the organization's needs, the Over-the-Road Safety role(s) can be shared with the Non-Production Site Safety role(s), and either can be combined with other organization roles. We are not mandating the organizational structure, just ensuring the competency and authority of those in the designated roles. If a bottler's organizational design includes site, regional, or other safety roles beyond the corporate safety role, those roles are also evaluated in this pillar.\n\n" +
                    "Safety Experience: Full points obtained if the person has relevant experience in the Safety or Logistics fields for 2-3 or more years.\n\n" +
            ...
            },
            {
                clause: "RTM-3",
                question:
                    "Key leadership positions filled and have the competence to perform their specific roles in the organization's safety management system (SMS), including programs for: organization-level risk assessment, incident investigation, and KPI tracking.\n\n" +
                ...
                intent:
                    "The intent is that the key leadership positions are filled and are capable, and competent to demonstrate safety leadership and to fulfill their specific roles in the organization's SMS. We are not looking at a minimum number of years of experience, or specific mandatory courses, but knowledge and understanding.\n\n" +
            ...
            },
            {
                clause: "RTM-4",
                question:
                    "Key roles that can affect the organization's Safety performance are filled and have the competence to perform their specific roles in the site's Safety Management system (SMS).\n\n" +
                ...
                intent:
                    "We want to assess if for the key Safety roles that we identify (the ones listed in the question or similar roles with high impact on safety performance), if they have competent and trained people capable of performing the necessary tasks linked with their roles. This should be evaluated by the auditor based on the different interviews conducted during the audit week with at least one person from each of the key Safety roles.\n\n" +
                    ...
                    "Note: it is OK if some roles are combined, are contracted out, or are based at a sister site and not on the specific site, as long as the person is clearly identified and has full ownership and accountability.\n\n" +
            ...
            },
            {
                clause: "RTM-5",
                question:
                    "Are the specific competency, skill, training, and certification requirements for each position defined and documented in a Job Description or similar means?",
                intent:
                    "Check if the organization has determined the necessary competence of workers that affects or can affect its OH&S performance, including the knowledge and skills needed to appropriately identify the hazards and deal with the Safety risks associated with their work and workplace.\n\n" +
                    ...
                    "   o Understanding traffic laws, regulations, and enforcement strategies.\n" +
                    "   o Knowledge of road design principles, and safety features.\n" +
                    "   o Familiarity with Internal 'Causes of incidents', investigation analysis.\n" +
                    "2. Data Analysis and Interpretation:\n" +
                    "   o Proficiency in analyzing internal road safety data to identify trends, high-risk areas, and contributing factors to accidents.\n" +
                    "   o Skills in interpreting data to make informed decisions and develop evidence-based interventions.\n" +
                    "3. Risk Assessment and Management:\n" +
                    "   o Ability to conduct risk assessments of roads and traffic systems.\n" +
                    "   o Skills in identifying potential hazards and implementing mitigation measures.\n" +
                    "   o Ability to monitor progress, evaluate outcomes, and make necessary adjustments on actions from CAP's or projects.\n" +
                    "5. Training and Capacity Building:\n" +
                    "   o Ability to conduct training programs and workshops for road safety professionals and stakeholders.\n" +
                    "   o Skills in developing training materials and curricula.\n" +
                    "6. Innovation and Technology:\n" +
                    "   o Familiarity with emerging technologies and innovations in road safety (e.g., telematics, safety devices on vehicles) and ability to leverage that technology to enhance road safety.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "RTM-6",
                question:
                    "When a key associate in any of the roles identified in section 1 above leaves the company, does the organization have a process in place to ensure their primary responsibilities are covered and a back-up person is identified?",
                intent:
                    "We are trying to assess whether there is adequate bench strength with trained backups available for key roles in case anyone leaves.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                ...
                question:
                    "Is there a formal and documented training and onboarding program as described in LSR 3.2 to ensure employees understand the job requirements and are competent to perform the functions and to ensure that only qualified people do the job?",
                intent:
                    "Based on the key Safety positions and the key competencies required for each role, check if the plant has defined an onboarding program fit for purpose.\n\n" +
                    "From LSR 3, 3.2: At a minimum the Training Plan should be developed by all levels and must consider:\n" +
                    "1. Risk Assessment and Controls\n" +
                    "2. High-Risk Work\n" +
                    "3. KORE Requirements content\n" +
                    "4. Internal and external training to perform High-Risk work\n" +
                    "5. New training content to address Call to Actions\n" +
                    "6. Safety orientation before starting their work\n" +
                    "7. Life Saving Rules (LSR)\n" +
                    "8. Other applicable training requirements based on job description and expected tasks to be performed (for instance, defensive driving training).",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "RTM-8",
                question:
                    "Is there evidence that the initial training and onboarding process as described in LSR 3.2 is implemented and followed (0-5) including measurement of training effectiveness and actions in case training is not accomplished (0-5)?",
                intent:
                    "Verify that onboarding records and training are being tracked and supervised and in case some training failed, check if it was identified by the organization and what was the follow up action.\n\n" +
            ...
            },
            {
                clause: "RTM-10",
                question:
                    "Contractors, Temporary workers, and 3rd party drivers:\n" +
                ...
                intent:
                    "Ensure that the organization has defined a process to identify key competencies needed for contractors, temporary positions and 3rd party drivers, if there is a training program defined, and if it is followed.\n\n" +
    ...
    },
    {
        ...
        module: "EOSH",
        description:
            "EOSH internal audit checklist for Climate Protection (HSHEQPF 03.08, Revision 0). Score findings as Compliance (2) / Meet with Exceptions (1) / Non-Compliance (0). Yellow/red scores require raised by, assign to, target date, and escalation follow-up.",
        content: [
            {
                clause: "CP-1",
                question:
                    "Are the climate protection requirements applied to the following types of equipment:\n" +
            ...
            },
            {
                clause: "CP-2",
                question:
                    "Does the company install new equipment that utilizes natural refrigerants or alternative ultra-low Global Warming Potential (GWP) refrigerants, in viable markets.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-3",
                question:
                    "For purchases, does the plant ensure insulation material is CFC-free, HCFC-free and HFC-free.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-4",
                question:
                    "Confirm if the plant does not purchase solvents containing ozone-depleting substances.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-5",
                question:
                    "Does the facility implement controls to ensure that the use, recovery and disposal of refrigerants, gases and other materials are managed safely and will not release in-scope compounds into the atmosphere.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-6",
                question:
                    "Does the facility capture the refrigerant charge of systems containing in-scope compounds when they must be opened for servicing, or when the equipment is discarded.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-7",
                question:
                    "Does the facility reuse, recycle, reclaim or destroy in-scope compounds properly.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-8",
                question:
                    "Does the facility destroy contaminated or otherwise unusable refrigerant by a method approved under the Montreal Protocol.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-9",
                question:
                    "Does the facility use a certified and licensed destruction facility if one is available.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-10",
                question:
                    "Confirm the facility does not mix different types of refrigerants when recovering them.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-11",
                question:
                    "Does the facility ensure routine maintenance of containers and equipment (including refrigeration or air conditioning systems) containing in-scope compounds, including checking for and fixing leaks.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-12",
                question:
                    "Confirm the facility does not use solvents that contain ozone-depleting substances.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-13",
                question:
                    "Does the facility measure and document the amounts of refrigerants, gases and other materials that contain in-scope compounds (including new purchases) stored, used, recovered, transferred offsite or destroyed/disposed.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-14",
                question:
                    "Have site employees and contractors servicing refrigeration and air conditioning systems been trained on the following:\n" +
                    "· Trained on applicable legal requirements for capturing and handling in-scope compounds.\n" +
                    "· Informed of site requirements on managing in-scope compounds.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CP-15",
                question:
                    "Does the facility maintain documentation that confirms the qualifications and certifications of employees, contractors and technicians who service refrigeration equipment, including immediate consumption equipment.",
                findings: "",
                evidence: "",
                ofi: "",
            },
    ...
    },
    {
        ...
        module: "EOSH",
        description:
            "EOSH internal audit checklist for Compressed Gases (HSHEQPF 03.08, Revision 0). Score findings as Compliance (2) / Meet with Exceptions (1) / Non-Compliance (0). Yellow/red scores require raised by, assign to, target date, and escalation follow-up.",
        content: [
            {
                clause: "CG-1",
                question:
                    "Are compressed gas containers protected from physical damage during storage & use to prevent tipping or falling.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-2",
                question:
                    "Are compressed gas containers protected from physical damage during transportation to prevent tipping or falling (Assess the mode of transport used).",
                findings: "",
                evidence: "",
                ofi: "",
            },
            ...
            },
            {
                clause: "CG-5",
                question:
                    "Is there segregation of incompatible gases or materials — minimum distance of 6 metres or by a noncombustible barrier at least 1.5 meters high.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-6",
                question:
                    "Are oxygen cylinders being stored away from combustible materials either 6 meters apart or barricaded with a noncombustible barrier at least 1.5 meters high with a fire resistance of one hour.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-7",
                question:
                    "If there is an Oxyacetylene system, do the trolleys used have a built-in fire barrier.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            ...
            },
            {
                clause: "CG-9",
                question:
                    "Are there gas supplier specifications for Gas delivery systems, manifolds and all components? Is there compliance.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-10",
                question:
                    "If no standard is available, is there compliance to American National Standard Code for Pressure Piping, Section 2: “Industrial Gas and Air Piping Systems” (ANSI B31.1-1967) or applicable consensus standard can be used as a design reference.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-11",
                question:
                    "Is there a preventative maintenance (PM) program for the gas delivery system, including the pressure relief valves.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-12",
                question: "Is the maintenance program being adhered to.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-13",
                question:
                    "Are there controls for compressed gas and other pressure systems to prevent the uncontrolled flow of gas or overpressure of equipment.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-14",
                question:
                    "Are there ways to control energy when working on compressed gas and other pressure systems in accordance with the company’s Hazardous Energy Control (ES-RQ-160) and line-breaking permit requirements. Review evidence.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-15",
                question:
                    "Do cylinders that are not connected or being used have valve protection caps.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-16",
                question:
                    "Has the plant provided proper apparatus to prevent backflow from high-pressure cylinders to empty/low-pressure cylinders.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-17",
                question:
                    "Are gas shutoff valves placed at readily accessible points on hazardous gas lines prior to entering occupied spaces.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-18",
                question:
                    "Are remotely operated master shutoff valves placed in a prominent, safe location for hazardous gases.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-19",
                question:
                    "Are delivery systems protected from accidental contact from vehicles or other hazards.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-20",
                question:
                    "Do Bulk storage tank systems comply with local regulations and manufacturer’s recommendations.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-21",
                question:
                    "Does the preventative maintenance (PM) program for bulk tanks:\n" +
            ...
            },
            {
                clause: "CG-22",
                question:
                    "Do the Bulk storage tanks have fit delivery systems with alarms and appropriate controls to shut off supplies at the source.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-23",
                question:
                    "Confirm if the Carbon dioxide bulk storage tanks do not contain alloys SA-212 or SA-515.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-24",
                question:
                    "Do Boilers and steam generators comply with local regulations and manufacturer recommendations.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-25",
                question:
                    "Do the boiler and steam generators have combustion safeguards that meet the requirements for the Controls and Safety Devices for Automatically Fired Boilers (ANSI/ASME CSD-1), or other locally appropriate consensus standard.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-26",
                question:
                    "Is there a PM program per manufacturer recommendations to include:\n" +
                    "• Safety devices\n" +
            ...
            },
            {
                clause: "CG-28",
                question:
                    "Are Liquid oxygen storage and handling areas, including offloading areas for liquid oxygen, free of combustible and hydrocarbon-based substances (e.g. wood, asphalt, oil, grease).",
                findings: "",
                evidence: "",
                ofi: "",
            },
            ...
            },
            {
                clause: "CG-30",
                question:
                    "Are flammable gas tanks and piping grounded. Ensure bonding across flanged pipeline connections through the use of unpainted nuts and bolts, or additional bonding connections.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-31",
                question:
                    "Is ammonia gas not stored or used near incompatible materials (e.g., oxidizing agents, halogens or heavy metals).",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-32",
                question:
                    "Confirm if there are no brass fittings or mercury pressure gauges in ammonia systems.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-33",
                question:
                    "Confirm if enclosed areas in which ammonia gas is used have:\n" +
            ...
            },
            {
                clause: "CG-34",
                question:
                    "Is there a smoke or heat detection and one-hour rated fire separation in ammonia compressor rooms that are inside, attached to, or within 15 meters (50 feet) of occupied buildings.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-35",
                question:
                    "Are Class I, Division II electrical systems or equivalent in all ammonia compressor rooms that do not meet the ventilation requirements.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            ...
            {
                clause: "CG-37",
                question: "Is there evidence that use of chlorine gas is the only viable option.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-38",
                question:
                    "Does the chlorine systems comply with local regulations and manufacturer/supplier recommendations.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-39",
                question:
                    "Is there a dedicated, outside structure that is a vapor-tight room or cabinet for operating chlorine gas cylinders within 15 meters of occupied areas. Does it include the following controls:\n" +
                    "29.1 Seal the pipe opening into occupied areas.\n" +
                    "29.2 Equip the door with emergency hardware that opens outward.\n" +
                    "29.3 Equip the structure with a ventilating fan that provides a minimum of one complete air exchange per minute.\n" +
                    "29.4 Locate separate switches for the fan and lights outside the room.\n" +
            ...
            },
            {
                clause: "CG-40",
                question:
                    "Confirm there are no floor drains in chlorine gas storage or use areas.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-41",
                question:
                    "Is there a plumbed emergency eyewash and deluge shower near the chlorine room.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-42",
                question:
                    "Is piping used to convey chlorine gas ASTM A333 carbon steel and alloy steel pipes in continuous lengths, with butt-welded, flanged or brazed joints. Screwed and socket-welded joints can be used in piping up to 4 cm (1.5 in).",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-43",
                question:
                    "Is secondary containment provided to the system external to the structure: double-walled piping or exhausted enclosures for piping valves, fittings, and related components.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-44",
                question:
                    "Are the dry chlorine systems protected from intrusion of moisture ≤ 20 ppm, including wet compressed air or exposure to ambient air.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-45",
                question:
                    "Is piping protected from overpressure where chlorine can be trapped between closed valves.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-46",
                question:
                    "Do asphyxiant gas systems comply with local regulations and manufacturer/supplier recommendations.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-47",
                question:
                    "Is there provision of direct ventilation to the atmosphere, or vent to an area where the gas will mix with air and not accumulate for interior systems.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-48",
                question:
                    "Are fixed gas detection systems provided as needed to ensure oxygen levels are appropriate (19.5–23.5%).",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-49",
                question:
                    "Is there a risk assessment done to determine if oxygen volume is less than 19.5% or a carbon dioxide volume greater than 2%.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-50",
                question:
                    "Has an interior and exterior audio/visual leak detection system been installed where risk assessment indicates, at an oxygen volume less than 19.5% or a carbon dioxide volume greater than 2%.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-51",
                question:
                    "Confirm the plant does not accept cryogenic containers showing ice buildup on the outside of the container.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-52",
                question:
                    "Have enclosed filling areas been provided with direct ventilation to the atmosphere, or vent to an area where the gas will mix with air and will not accumulate.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-53",
                question:
                    "Is there an audio/visual leak detection system in the work area around the carbon dioxide (CO2) filler, where risk assessment indicates, at an oxygen volume less than 19.5% or a carbon dioxide volume greater than 2%.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-54",
                question:
                    "Is there use of special vacuum jacket containers with loose-fitting lids or overpressure relief devices to handle small quantities of the liquid gas.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-55",
                question:
                    "For Continuous mechanical ventilation systems, require one of the following protections:\n" +
            ...
            },
            {
                clause: "CG-56",
                question:
                    "Are Asphyxiant gas cylinders inspected in accordance with legal regulations or at least every five years, whichever is more stringent.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-57",
                question:
                    "Are asphyxiant gas cylinders visually inspected for obvious damage (e.g. dents, leaks, broken or missing carry handles or valve-handles, and defective pressure reliefs).",
                findings: "",
                evidence: "",
                ofi: "",
            },
            ...
            },
            {
                clause: "CG-59",
                question:
                    "Have levels of training (awareness vs. interaction) been identified for the various employees.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-60",
                question: "Has awareness training been done for all employees.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-61",
                question:
                    "Does interaction training cover:\n" +
            ...
            },
            {
                clause: "CG-62",
                question:
                    "Do Ozone generation and delivery systems comply with local regulations and manufacturer/supplier recommendations.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-63",
                question:
                    "Are there ventilation controls provided as necessary to maintain personnel exposure levels below the 0.1 ppm, 8-hour, time-weighted average.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-64",
                question:
                    "Is there a risk assessment that quantifies exposures using acceptable industrial hygiene practices.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-65",
                question:
                    "If there are Continuous mechanical ventilation systems, do they have one of the following protections:\n" +
            ...
            },
            {
                clause: "CG-66",
                question:
                    "Is there an audio leak detection system in the ozone generator room and where the ozone is used/handled (include the filling room in case the ozone generator is within another room) at a detection limit of 0.1 ppm or the local regulatory minimum.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-67",
                question:
                    "Is the leak detection system installed according to manufacturer/supplier recommendations.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-68",
                question:
                    "Are all materials used to convey ozone compatible with ozone and meet manufacturer/supplier requirements.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-69",
                question:
                    "Do the Ozone generators display a visual notification when ventilation systems and detectors have failed and cause the generator to automatically shut down under the following conditions:\n" +
            ...
            },
            {
                clause: "CG-70",
                question:
                    "Is a designated, unoccupied, ozone-generator room or equipment enclosure provided if indicated by risk assessment.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-71",
                question:
                    "Are manual emergency shutdown controls provided at the ozone generator. If a designated, unoccupied, ozone-generator room is provided, the shutdown controls must be outside the room and within 3 meters (10 feet) of the main exit or exit access door.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-72",
                question:
                    "Is the area around the ozone generator kept free of combustible and hazardous material storage.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-73",
                question:
                    "Confirm there is no pooling of ozonated water from tank filler discharge or other equipment.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-74",
                question: "Confirm they do not sanitize the equipment externally with ozonated water.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-75",
                question:
                    "Is the contactor tank vented outside the building and equipped with an ozone destructor (e.g. carbon filter or UV lamps).",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CG-76",
                question:
                    "Is refresher training provided according to change management procedures or when there is evidence of knowledge deficiency.",
                findings: "",
                evidence: "",
                ofi: "",
            },
    ...
    },
    {
        ...
        module: "EOSH",
        description:
            "EOSH internal audit checklist for Confined Space (HSHEQPF 03.08, Revision 0). Score findings as Compliance (2) / Meet with Exceptions (1) / Non-Compliance (0). Yellow/red scores require raised by, assign to, target date, and escalation follow-up.",
        content: [
            {
                clause: "CS-1",
                question: "Is there an up-to-date inventory of confined spaces.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CS-2",
                question:
                    "Was a hazard assessment conducted to define the appropriate controls for each confined space.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            ...
            },
            {
                clause: "CS-5",
                question:
                    "Does the company have a stand-by communication process to ensure the communication is not breaking down through the work performed.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CS-6",
                question:
                    "Is there a permit program to control, monitor and document each entry into and work conducted in a confined space.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            ...
            },
            {
                clause: "CS-8",
                question:
                    "Does the permit capture all the relevant information. In lieu of local regulations, follow company guidelines.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CS-9",
                question:
                    "Are work permits posted at the entrance of the confined space or in the immediate work area for the duration of the work.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            ...
            },
            {
                clause: "CS-11",
                question:
                    "Was a risk assessment done to identify required control measures for entry.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CS-12",
                question:
                    "At a minimum, entry control measures must:\n" +
            ...
            },
            {
                clause: "CS-13",
                question:
                    "Is all equipment used during entry and for potential rescues maintained per manufacturer/supplier recommendations.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CS-14",
                question:
                    "Is there documented identification of the levels of training (awareness vs. involvement), and target employee populations.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CS-15",
                question:
                    "Have all employees attended initial awareness training for confined space recognition, potential hazards, and requirements for entry permits.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CS-16",
                question:
                    "Is there evidence of Training for the entry supervisor, entrants, attendants and rescuers & does it cover the following:\n" +
            ...
            },
            {
                clause: "CS-17",
                question:
                    "Is refresher training provided according to change management procedures when there is evidence of knowledge deficiency or personnel has not participated in a confined space entry in 12 months.",
                findings: "",
                evidence: "",
                ofi: "",
            },
            {
                clause: "CS-18",
                question:
                    "Training for the entry supervisor, entrants, attendants and rescuers must cover:\n" +
                    "a) The Confined Space Entry Program, including roles and responsibilities.",
                findings: "",
                evidence: "",
                ofi: "",
            ...
            },
            {
                clause: "CS-21",
                question:
                    "Is there an annual simulated rescue practice with participation from the entire onsite rescue team for the internal rescue services.",
                findings: "",
                evidence: "",
                ofi: "",
            },
    ...
    },
    {
        ...
        module: "EOSH",
        description:
            "ISO 45001:2018 management system audit checklist (REQUIREMENT / QUESTION / OK / NOT OK / COMMENT). Covers clauses 4.4, 5.1–5.3, 6.1–6.2, 7.1–7.5, 8.1–8.2, 9.1.1, and 10.1–10.2.",
        content: [
            {
                clause: "4.4",
                question:
